...
{
    public partial class newDbClgContext : DbContext
    {
        public newDbClgContext()
        {
        }

        public newDbClgContext(DbContextOptions<newDbClgContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.RollNumber, "UQ__Students__2966FED9F53EBF75")
                    .IsUnique();
