...
namespace VNRWEBAPI.Repository
{
    ...
    {
        private readonly newDbClgContext _dbContext;//declaring private variable

        public TeacherRepository(newDbClgContext dbContext)//Constructor 
        {
        ...
        public void AddTeacher(TeacherVM teachervm)
        {
            ...
            var results = (from tt in _dbContext.Teachers
                           ...
                           let EmployeeId = tt.EmployeeId.Substring(3, 3)
                           select new
                           {
                               EmployeeId
                           }
